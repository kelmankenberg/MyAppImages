...
exports.IconExtractionService = void 0;
...
class IconExtractionService {
     ...
     */
    getIconCacheKey(appImagePath, mtimeMs) {
     ...
     */
    getCachedIconPath(appImagePath, mtimeMs) {
     ...
     */
    clearUnusedIcons(validCacheKeys) {
        try {
     ...
     */
    async extractIcon(appImagePath, mtimeMs) {
        try {
            // Check cache first
            ...
            try {
                ...
                const cacheKey = this.getIconCacheKey(appImagePath, mtimeMs);
                const targetFormat = ext === '.svg' ? 'svg' : 'png';
     ...
     */
    extractAppImage(appImagePath, outputDir) {
        return new Promise((resolve, reject) => {
            const timeout = setTimeout(() => {
                reject(new Error('AppImage extraction timed out'));
            }, 30000); // 30 second timeout
            try {
                const child = (0, child_process_1.spawn)(appImagePath, ['--appimage-extract'], {
                    cwd: outputDir,
     ...
     */
    async findAndResolveDirIcon(extractDir) {
        try {
    ...
    convertSvgToPng(svgPath, pngPath) {
        return new Promise((resolve, reject) => {
            ...
            const child = (0, child_process_1.spawn)('convert', [
                '-background', 'none',
                '-density', '300',
                svgPath,
                '-resize', '256x256',
...
exports.IconExtractionService = IconExtractionService;
//# sourceMappingURL=icon-extraction.service.js.map